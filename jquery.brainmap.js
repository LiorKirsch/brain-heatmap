			...
			if (!(svgElement == null) ) {
                ...
                if (!$(svgElement).data('bound') ) {
                      ...
                      $(svgElement).mouseenter(function() {
                              this.style.strokeBefore = this.style.stroke;
							  this.style.stroke = "#cf3";
                              this.style.strokeWidthBefore = this.style.strokeWidth;
                              ...
                              this.style.stroke = this.style.strokeBefore;
                              this.style.strokeWidth = this.style.strokeWidthBefore;
